...
\newcommand{\vdc}{V$_{DC}$\xspace}
\newcommand{\vac}{V$_{AC}$\xspace}
...
\input{./tex/IMD.tex}\label{sebsec:IMD}

\subsection{Inertia Switch} \label{subsec:InertiaSwitch}
% nefunguje odakzy
\input{./tex/InertiaSwitch.tex}
...
%Responsible: Janko
%schemata
\input{./tex/MeasurementPoints.tex}

\subsection{Pre-Charge circuitry}\label{subsec:PrechargeCircuitry}
%Responsible: JSi
%ECUA
\input{./tex/PrechargeCircuitry.tex}
