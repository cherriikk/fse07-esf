...
\begin{table}[H]
	...
	\begin{tabu}{|X|X|}
		\hline
		Relay Type: & TE PE014012, one per 3s resistor bank (130 mA)\\
		\hline
		Contact arrangement: & 1 pole, normally closed  \\
		\hline
		Continuous DC current: & 5 A \\
		\hline
		Voltage rating  & $250 V_{ac}$/$30 V_{dc}$ $^1$ \\
		\hline
